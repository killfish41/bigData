...
public class test033 {
    public static void main(String[] args) throws Exception {
        File file = new File("H:\\安装资料\\任务\\任务\\zpsjj\\jobs3.csv");
...
//            System.out.println(s1);
            ...
            else if (experience.contains("经验不限")){
                experience_max = -1;
                experience_min = -1;
            }else {
            ...
            if ("面议".equals(salary)){
                ...
                salary_min = Integer.parseInt(salary.split("-")[0]) / 12.0;
                salary_max = Integer.parseInt(salary.split("-")[1].split("万")[0]) / 12.0;
            }
